...
website = "https://kpopping.com/profiles/the-idols/men"
...
for item in box:
    ...
    temp = "INSERT INTO GRUPO(id_grupo,nombreGrupo,imagenGrupo) VALUES('D" + str(box.index(item)) + "','" + nombreGrupo + "','-');"
    ...
    for item2 in canciones:
        ...
        temp2 = "INSERT INTO CANCION(id_grupo,nombreCancion) VALUES('D" + str(box.index(item)) + "','" + nombreCancion2 +"');"
